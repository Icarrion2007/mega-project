// src/components/TriangulationPreview.js - UPDATED FOR FEC CONTRIBUTION DATA v3.1
...
const TriangulationPreview = () => {
  ...
  return (
    <section style={{ padding: '2rem 1rem', maxWidth: '1400px', margin: '0 auto' }}>
      <SectionTitle>Triangulation Engine v3.1</SectionTitle>
      ...
      <TriangulationContainer>
          ...
          {filteredResults.length > 0 ? (
            filteredResults.slice(0, 15).map((item, index) => (
              <ContributionCard 
                key={index} 
                amount={item.amount}
                title={`${item.contributor || 'Anonymous'} → ${item.recipient || 'Unknown'}`}
              >
                <ContributionHeader>
                ...
                <ContributorInfo>
                  ...
                  <MetaInfo>
                    {item.occupation && <Chip>👤 {item.occupation}</Chip>}
                    {item.employer && <Chip>🏢 {item.employer}</Chip>}
                    {item.state && <Chip>📍 {item.state}</Chip>}
                  </MetaInfo>
                </ContributorInfo>
                
                <RecipientInfo>
                  <span>🏛️ Recipient: {item.recipient || 'N/A'}</span>
                </RecipientInfo>
        ...
        <Column>
          ...
          <ContributionCard>
            <ContributorInfo>
              ...
              <MetaInfo>
                <Chip>🏛️ H.R.1 - For the People Act</Chip>
                <Chip>📅 Introduced 2025-01-10</Chip>
              </MetaInfo>
            </ContributorInfo>
          ...
          <ContributionCard>
            <ContributorInfo>
              ...
              <MetaInfo>
                <Chip>🗣️ Presidential Address</Chip>
                <Chip>📍 White House</Chip>
              </MetaInfo>
            </ContributorInfo>
            <p style={{ marginTop: '0.5rem', lineHeight: '1.6' }}>
          ...
          <ContributionCard>
            <ContributorInfo>
              ...
              <MetaInfo>
                <Chip>📋 FEC Press Release</Chip>
                <Chip>⚖️ Regulatory Framework</Chip>
              </MetaInfo>
            </ContributorInfo>
            <p style={{ marginTop: '0.5rem', lineHeight: '1.6' }}>
          ...
          <ContributionCard style={{ background: 'linear-gradient(135deg, #667eea20 0%, #764ba220 100%)', borderColor: '#667eea' }}>
            <ContributorInfo>
              <strong>🔮 Next Integration Phase</strong>
            </ContributorInfo>
        ...
        <Column>
          ...
          <ContributionCard>
            <ContributorInfo>
              <strong>📊 Contribution Distribution Analysis</strong>
            </ContributorInfo>
          ...
          <ContributionCard>
            <ContributorInfo>
              <strong>🎯 Policy Correlation Index</strong>
            </ContributorInfo>
            <p style={{ marginTop: '0.5rem', lineHeight: '1.6' }}>
            ...
            <MetaInfo style={{ marginTop: '0.5rem' }}>
              <Chip>📈 0.87 correlation coefficient</Chip>
              <Chip>⚖️ p-value &lt; 0.001</Chip>
            </MetaInfo>
          </ContributionCard>
          
          <ContributionCard>
            <ContributorInfo>
              <strong>👥 Public Trust Metrics</strong>
            </ContributorInfo>
            <ul style={{ marginTop: '0.5rem', lineHeight: '1.6' }}>
          ...
          <ContributionCard style={{ background: 'linear-gradient(135deg, #2e7d3220 0%, #4a6fa520 100%)', borderColor: '#2e7d32' }}>
            <ContributorInfo>
              <strong>🔬 Next Analysis Layer</strong>
            </ContributorInfo>
            <ul style={{ marginTop: '0.5rem', paddingLeft: '1.2rem' }}>
      ...
      <Timestamp>
        ...
        <div style={{ fontSize: '0.8rem', opacity: 0.8 }}>
          M.E.G.A. Project v3.1 · Triangulation Engine Active · FEC API v1 · Phase 3.3 Complete
        </div>
      </Timestamp>
    </section>
  );
